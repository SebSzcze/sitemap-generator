    ...
    <xsl:template match="/">
        ...
        <div id="content">
            ...
            <xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) &lt; 1">
                ...
                <p class="expl"><a href="{{ url('sitemap.xml') }}">&#8593; Sitemap Index</a></p>
                <table id="sitemap" cellpadding="3">
                    <thead>
                    <tr>
                        <th width="80%">URL</th>
        ...
        <script type="text/javascript" src="https://wysokienapiecie.pl/backend/wp-includes/js/jquery/jquery.js"></script>
        <script type="text/javascript" src="https://wysokienapiecie.pl/wp-content/plugins/wordpress-seo/js/dist/jquery.tablesorter.min.js"></script>
